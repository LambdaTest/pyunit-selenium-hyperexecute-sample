...
class HTML_TestRunner_TestSuite(unittest.TestCase):
    def test_consolidated_suite(self):
        ...
        output_file = open(current_directory + "\\HTML_Test_Runner_ReportTests", "w")

        html_runner = HtmlTestRunner.HTMLTestRunner(
            stream=output_file,
            report_title='Test Report - PyUnit on Hypertest',
            descriptions='Test Report - PyUnit on Hypertest'
        )
