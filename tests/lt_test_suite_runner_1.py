...
class HTML_TestRunner_TestSuite(unittest.TestCase):
    def test_consolidated_suite(self):
        ...
        html_runner = HtmlTestRunner.HTMLTestRunner(
            stream=output_file,
            report_title='Test_1 Report - PyUnit on Hypertest',
            descriptions='Test_1 Report - PyUnit on Hypertest'
        )
    ...
    def test_consolidated_suite_2(self):
        ...
        html_runner = HtmlTestRunner.HTMLTestRunner(
            stream=output_file,
            report_title='Test_2 Report - PyUnit on Hypertest',
            descriptions='Test_2 Report - PyUnit on Hypertest'
        )
        html_runner.run(consolidated_test)
