...
[<img alt="Run in Gitpod" width="200 px" align="center" src="images/Gitpod.svg" />](https://hyperexecute.lambdatest.com/hyperexecute/jobs?type=gitpod&framework=PyUnit)
---
...
# How to run Selenium automation tests on HyperExecute (using PyUnit framework) — TestMu AI (Formerly LambdaTest)
